def day02part01():
    with open(r"Day 02 old\input.txt", "r") as f:
        ...
        while i < len(fullList):
            a = fullList[i].split("-")
            # lowest iteration of the searched letter you have to have to get your password validated
            low = int(a[0])
            # highest iteration of the searched letter you have to have to get your password validated
            high = int(a[1])
