with open(r"input.txt", "r") as f:
    ...
    while i < len(fullList):
        a = fullList[i].split("-")
        low = int(a[0]) # lowest iteration number of the searched letter you have to have to get your password validated
        high = int(a[1]) # highest iteration number of the searched letter you have to have to get your password validated
